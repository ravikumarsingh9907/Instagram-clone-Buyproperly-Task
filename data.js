...
for (const data of posts) {
  id.push(data.id);
  imgUrl.push(data.display_src);
  likes.push(data.likes);
  caption.push(data.caption);
  code.push(data.code);
}

var imgLocation = imgUrl.reduce(function (result, field, index) {
  result[id[index]] = field;
  return result;
}, {});

var likesLocation = likes.reduce(function (result, field, index) {
  result[id[index]] = field;
  return result;
}, {});

var captionLocation = caption.reduce(function (result, field, index) {
  result[id[index]] = field;
  return result;
}, {});

var codeLocation = code.reduce(function (result, field, index) {
  result[id[index]] = field;
  return result;
}, {});
